...
def create_parser():
    ...
    parser.add_argument('-w', "--weight", dest='weight', type=int, help="Weight in kilograms")
    parser.add_argument('-l', "--length", dest= 'length', type=int, help="Length in centimeters") 
    return parser
